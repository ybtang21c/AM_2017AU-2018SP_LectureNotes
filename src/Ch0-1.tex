...
我们一般认为，微积分诞生于17世纪初，当时的两位数学巨匠Newton(1642-1726)和
...
giants.}”，在两位大师身前和身后，众多杰出的数学家都为微积分的作出了
关键性的贡献，其中包括Fermat(1607-1665)、Barrow(1630-1677)、
Descartes(1596-1650)等人的奠基性工作，也包括Cauchy(1789-1857)、
D.Bernoulli(1700-1782)、Lagrange(1736-1913)、Weierstrass(1815-1897)、
Dirichlet(1805-1859)、Taylor(1685-1731)、Euler(1707-1783)、R
iemann(1826-1866)、d'Alembert(1717-1783)等对这一理论
体系的不断完善和深入挖掘。今天我们所学习的微积分，虽然只是这一学科
\ps{更准确的说法应该叫分析学，它和几何学、代数学并称现代数学的三大分支，
三者各自拥有庞大的理论体系，在它们的交汇处诞生了众多重要而又生机勃勃的
数学前沿分支}的基础部分，但要说其中融汇了200多年来众多现代数学家
的杰出成就，是毫不为过的。
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item 及时订正错误，补上缺漏
  \begin{center}
  	\includegraphics[width=\textwidth]{./images/00/hw-sample.jpg}
